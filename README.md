...
Requires the [GitHub CLI](https://cli.github.com/) (`gh`). Replace `dynamo-951d608-data-querying-and-databases`
with the repository you were assigned:

```bash
gh repo fork handshake-project-dynamo/dynamo-951d608-data-querying-and-databases --clone
cd dynamo-951d608-data-querying-and-databases
git checkout -b submission
#  ... build the task (see below) ...
git add -A && git commit -m "Task submission"
git push -u origin submission
gh pr create --repo handshake-project-dynamo/dynamo-951d608-data-querying-and-databases --fill
```
